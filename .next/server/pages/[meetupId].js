...
/* harmony default export */ var MeetupDetails = (MeetupDetailsLayout);
...
function _meetupId_MeetupDetails(props) {
  return /*#__PURE__*/Object(jsx_runtime_["jsx"])(MeetupDetails, {
...
async function getStaticPaths() {
  const client = await external_mongodb_["MongoClient"].connect('mongodb+srv://justantvish:220918Neshama@cluster0.1tceys8.mongodb.net/meetups?retryWrites=true&w=majority');
  const db = client.db();
